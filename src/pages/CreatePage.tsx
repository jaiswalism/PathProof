...
const CreatePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const deviceId = import.meta.env.VITE_DEVICE_ID; ; // fixed or from browser/device ID

      // const proofHash = await generateProof(lat, lng, timestamp, deviceId);
      const { proof, publicSignals } = await generateProof(lat, lng, timestamp, deviceId, true);
